...
namespace API.LocalClass
{
    public static class StationsClass
    {
        ...
        private static List<Station_Request> ListOfStations(ClaimsPrincipal _user, Filter_Request Filtros)
        {
            ...
            {
                Logs_ErroresClass.NuevoLog(_user, "Could not load list of stations", SystemActionsEnum.SearchList, SystemTypesEnum.API, e, SystemErrorCodesEnum.Error);
        ...
        public static GlobalResponse Create(ClaimsPrincipal _user, Station_Request model)
        {
            ...
            catch (Exception e)
            {
                ...
                Logs_ErroresClass.NuevoLog(_user, "Could not create the station", SystemActionsEnum.Create, SystemTypesEnum.API, e, SystemErrorCodesEnum.Error);
        ...
        public static GlobalResponse Modify(ClaimsPrincipal _user, Station_Request model)
        {
            ...
            try
            {
                ...
                station.Modify_IDuser = UsersClass.GetID_User(_user);
            ...
            catch (Exception e)
            {
                ...
                Logs_ErroresClass.NuevoLog(_user, "Could not modify station", SystemActionsEnum.Modify, SystemTypesEnum.API, e, SystemErrorCodesEnum.Error);
        ...
        public static GlobalResponse Delete(ClaimsPrincipal _user, DeleteStation_Request model)
        {
            ...
            catch (Exception e)
            {
                ...
                Logs_ErroresClass.NuevoLog(_user, "Could not delete station", SystemActionsEnum.Delete, SystemTypesEnum.API, e, SystemErrorCodesEnum.Error);
