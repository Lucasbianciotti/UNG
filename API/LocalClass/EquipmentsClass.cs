...
namespace API.LocalClass
{
    public static class EquipmentsClass
    {
        ...
        private static List<Equipment_Request> ListOfEquipments(ClaimsPrincipal _user, long IDstation, Filter_Request filter = null)
        {
            ...
            try
            {
                var lista = (from Equipment in db.Equipments
                             ...
                             select new Equipment_Request
                             {
                                 ...
                                 ListOfData = (from data in db.Data
            ...
            {
                Logs_ErroresClass.NuevoLog(_user, "Could not load list of equipments", SystemActionsEnum.SearchList, SystemTypesEnum.API, e, SystemErrorCodesEnum.Error);
        ...
        private static Equipment_Request SearchEquipment(ClaimsPrincipal _user, long IDequipment)
        {
            ...
            {
                Logs_ErroresClass.NuevoLog(_user, "Could not search equipment", SystemActionsEnum.SearchList, SystemTypesEnum.API, e, SystemErrorCodesEnum.Error);
        ...
        public static GlobalResponse Create(ClaimsPrincipal _user, Equipment_Request model)
        {
            ...
            try
            {
                var Equipment = new Equipments
                {
                    ...
                    Modify_IDuser = UsersClass.GetID_User(_user),
                    Name = model.Name,
            ...
            catch (Exception e)
            {
                ...
                Logs_ErroresClass.NuevoLog(_user, "Could not create the equipment", SystemActionsEnum.Create, SystemTypesEnum.API, e, SystemErrorCodesEnum.Error);
        ...
        public static GlobalResponse Modify(ClaimsPrincipal _user, Equipment_Request model)
        {
            ...
            try
            {
                ...
                Equipment.Modify_IDuser = UsersClass.GetID_User(_user);
            ...
            catch (Exception e)
            {
                ...
                Logs_ErroresClass.NuevoLog(_user, "Could not modify equipment", SystemActionsEnum.Modify, SystemTypesEnum.API, e, SystemErrorCodesEnum.Error);
        ...
        public static GlobalResponse Delete(ClaimsPrincipal _user, DeleteEquipment_Request model)
        {
            ...
            catch (Exception e)
            {
                ...
                Logs_ErroresClass.NuevoLog(_user, "Could not delete equipment", SystemActionsEnum.Delete, SystemTypesEnum.API, e, SystemErrorCodesEnum.Error);
